...
%DEFAULT EVENT_PATH 's3://mbeacon-hadoop-development/data/staging/events.bson'
--%DEFAULT EVENT_PATH 'mongodb://prod-mongodb-01-a.awsservers.mobiquitynetworks.com:27017/backend.events'
%DEFAULT REGION_VENUE_PATH 's3://mbeacon-hadoop-development/data/staging/venues-region/part*.bson'
--%DEFAULT COMBINATIONS_PATH '/tmp/combinations/part-r-*'
%DEFAULT COMBINATIONS_PATH 's3://mbeacon-hadoop-development/data/staging/combinations/part-r-*'
%DEFAULT OUTPUT_PATH 's3://mbeacon-hadoop-development/statistics_interface/stat-hour.bson'
%DEFAULT DIMENSIONS_PATH 's3://mbeacon-hadoop-development/data/staging/hadoop.bson'
...
set mapreduce.output.fileoutputformat.outputdir 's3://mbeacon-hadoop-development/data/staging/statistics-staging'
