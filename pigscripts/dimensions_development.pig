 ...
 */
%DEFAULT DIMENSION_PATH 's3://mbeacon-hadoop-development/data/development/hadoop.bson'
%DEFAULT OUTPUT_PATH 's3://mbeacon-hadoop-development/data/development/combinations'
