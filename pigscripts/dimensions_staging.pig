 ...
 */
%DEFAULT DIMENSION_PATH 's3://mbeacon-hadoop-development/data/staging/hadoop.bson'
%DEFAULT OUTPUT_PATH 's3://mbeacon-hadoop-development/data/staging/combinations'
