...
%DEFAULT REGION_PATH 's3://mbeacon-hadoop-development/data/production/regions.bson'
%DEFAULT VENUE_PATH 's3://mbeacon-hadoop-development/data/production/venues.bson'
...
set mapreduce.output.fileoutputformat.outputdir 's3://mbeacon-hadoop-development/data/production/venues-region'
